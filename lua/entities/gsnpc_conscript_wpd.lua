...
ENT.Type = "nextbot"
ENT.PrintName = "WPD Conscript" -- The name that will appear in the spawn menu.
...
list.Set( "NPC", "gsnpc_conscript_wpd", {
	Name = "WPD Conscript",
	Class = "gsnpc_conscript_wpd",
...
ENT.Model = "models/player/swat.mdl"  -- Model used by the NPC
