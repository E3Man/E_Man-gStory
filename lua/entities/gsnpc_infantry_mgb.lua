...
list.Set( "NPC", "gsnpc_infantry_mgb", {
	Name = "Mingebag Infantry",
	Class = "gsnpc_infantry_mgb",
...
ENT.PreferredCombatTask = {"TacticalAI_Strafe", "FodderAI_Flanker", "TacticalAI_CircularStrafe"}
