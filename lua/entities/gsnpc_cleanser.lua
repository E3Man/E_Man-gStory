...
ENT.Type = "nextbot"
ENT.PrintName = "Cleanser" -- The name that will appear in the spawn menu.
...
list.Set( "NPC", "gsnpc_cleanser", {
	Name = "Cleanser",
	Class = "gsnpc_cleanser",
...
--- WEAPONS & BACKPACK ---
ENT.Weapon = "gswep_shotgun"          -- Weapon used by the NPC. Will also be put in its inventory
...
ENT.PreferredCombatTask = "TacticalAI_SneakyRush"
