...
ENT.Type = "nextbot"
ENT.PrintName = "Mingebag Combatant" -- The name that will appear in the spawn menu.
ENT.Author = "E_Man" -- The author's name for this Entity.
ENT.Category = "gStory" -- The category for this Entity in the spawn menu.
ENT.Purpose = "Elite mingebag fighter" -- The purpose of this Entity.
ENT.Spawnable = true -- Specifies whether this Entity can be spawned by players in the spawn menu.
ENT.AdminOnly = true

list.Set( "NPC", "gsnpc_combatant_mgb", {
	Name = "Mingebag Combatant",
	Class = "gsnpc_combatant_mgb",
